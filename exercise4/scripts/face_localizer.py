...
class face_localizer:
    ...
    def get_pose(self,coords,dist,stamp):
        ...
        try:
            ...
            if add:
                ...
                if last_detected_face[0] + margin1 > point_world.point.x and last_detected_face[0] - margin1 < point_world.point.x and last_detected_face[1] + margin1 > point_world.point.y and last_detected_face[1] - margin1 < point_world.point.y and last_detected_face[2] + margin1 > point_world.point.z and last_detected_face[2] - margin1 < point_world.point.z:
    ...
    def pub_front_face(self, face_pose):
        ...
        try:
            ...
            print(e)
        print(point_world)
        x, y = point_world.point.x, point_world.y

        dx = x - xF
        dy = y - yF
        xN = dx / float(dx + dy) # normalize
        yN = dy / float(dx + dy)
